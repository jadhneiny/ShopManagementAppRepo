...
public partial class UserManagementService
{
    public async Task<Admins> Get_Admins_By_ADMINS_ID(Params_Get_Admins_By_ADMINS_ID i_Params_Get_Admins_By_ADMINS_ID)
    {
        try
        {
            ...
            oAdmins = await _userManagementRepository.Get_Admins_By_ADMINS_ID(i_Params_Get_Admins_By_ADMINS_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Admins>> Get_Admins_By_ADMINS_ID_List(Params_Get_Admins_By_ADMINS_ID_List i_Params_Get_Admins_By_ADMINS_ID_List)
    {
        try
        {
            ...
            oList_Admins = await _userManagementRepository.Get_Admins_By_ADMINS_ID_List(i_Params_Get_Admins_By_ADMINS_ID_List).ConfigureAwait(false);
    ...
    public async Task<Get_Admins_By_Properties_Response> Get_Admins_By_Properties(Params_Get_Admins_By_Properties i_Params_Get_Admins_By_Properties)
    {
        try
        {
            ...
            oGet_Admins_By_Properties_Response = await _userManagementRepository.Get_Admins_By_Properties(i_Params_Get_Admins_By_Properties).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Admins>> Get_Admins_By_TENANT_ID(Params_Get_Admins_By_TENANT_ID i_Params_Get_Admins_By_TENANT_ID)
    {
        try
        {
            ...
            oList_Admins = await _userManagementRepository.Get_Admins_By_TENANT_ID(i_Params_Get_Admins_By_TENANT_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Admins>> Get_Admins_By_TENANTS_ID(Params_Get_Admins_By_TENANTS_ID i_Params_Get_Admins_By_TENANTS_ID)
    {
        try
        {
            ...
            oList_Admins = await _userManagementRepository.Get_Admins_By_TENANTS_ID(i_Params_Get_Admins_By_TENANTS_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Admins>> Get_Admins_By_TENANTS_ID_List(Params_Get_Admins_By_TENANTS_ID_List i_Params_Get_Admins_By_TENANTS_ID_List)
    {
        try
        {
            ...
            oList_Admins = await _userManagementRepository.Get_Admins_By_TENANTS_ID_List(i_Params_Get_Admins_By_TENANTS_ID_List).ConfigureAwait(false);
    ...
    public async Task<Customers> Get_Customers_By_CUSTOMERS_ID(Params_Get_Customers_By_CUSTOMERS_ID i_Params_Get_Customers_By_CUSTOMERS_ID)
    {
        try
        {
            ...
            oCustomers = await _userManagementRepository.Get_Customers_By_CUSTOMERS_ID(i_Params_Get_Customers_By_CUSTOMERS_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Customers>> Get_Customers_By_CUSTOMERS_ID_List(Params_Get_Customers_By_CUSTOMERS_ID_List i_Params_Get_Customers_By_CUSTOMERS_ID_List)
    {
        try
        {
            ...
            oList_Customers = await _userManagementRepository.Get_Customers_By_CUSTOMERS_ID_List(i_Params_Get_Customers_By_CUSTOMERS_ID_List).ConfigureAwait(false);
    ...
    public async Task<Get_Customers_By_Properties_Response> Get_Customers_By_Properties(Params_Get_Customers_By_Properties i_Params_Get_Customers_By_Properties)
    {
        try
        {
            ...
            oGet_Customers_By_Properties_Response = await _userManagementRepository.Get_Customers_By_Properties(i_Params_Get_Customers_By_Properties).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Customers>> Get_Customers_By_TENANT_ID(Params_Get_Customers_By_TENANT_ID i_Params_Get_Customers_By_TENANT_ID)
    {
        try
        {
            ...
            oList_Customers = await _userManagementRepository.Get_Customers_By_TENANT_ID(i_Params_Get_Customers_By_TENANT_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Customers>> Get_Customers_By_TENANTS_ID(Params_Get_Customers_By_TENANTS_ID i_Params_Get_Customers_By_TENANTS_ID)
    {
        try
        {
            ...
            oList_Customers = await _userManagementRepository.Get_Customers_By_TENANTS_ID(i_Params_Get_Customers_By_TENANTS_ID).ConfigureAwait(false);
    ...
    public async Task<IEnumerable<Customers>> Get_Customers_By_TENANTS_ID_List(Params_Get_Customers_By_TENANTS_ID_List i_Params_Get_Customers_By_TENANTS_ID_List)
    {
        try
        {
            ...
            oList_Customers = await _userManagementRepository.Get_Customers_By_TENANTS_ID_List(i_Params_Get_Customers_By_TENANTS_ID_List).ConfigureAwait(false);
